...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'key_id', 'usage_date', 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'key_id', 'usage_date' ], [ 'constraint' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'key_id', 'encrypt_count', 'decrypt_count', 'verify_count' ]; }

    /** @return array<string,string> alias => column (pro normalizaci vstupů) */
    public static function paramAliases(): array { return [ 'date' => 'usage_date' ]; }
