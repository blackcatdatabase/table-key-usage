...
namespace BlackCat\Database\Packages\KeyUsage\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO KeyUsageDto:
...
final class KeyUsageDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'key_id', 'encrypt_count', 'decrypt_count', 'verify_count' ];
    /** @var string[] */
    ...
    public static function fromRowOrNull(?array $row): ?KeyUsageDto
    {
    ...
    public static function toRowNonNull(KeyUsageDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KeyUsageDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KeyUsageDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KeyUsageDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KeyUsageDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KeyUsageDto>
     */
