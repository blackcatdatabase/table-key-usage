...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'key_id', 'usage_date', 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ];
    }
    ...
    {
        $x = [ 'id', 'key_id', 'usage_date', 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\KeyUsage\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\KeyUsage\Definitions::softDeleteColumn();
