 ...
 * - whitelist filtrů: [ 'id', 'key_id', 'date', 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ]
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'key_id', 'date', 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'key_id', 'date', 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ], true);
            $parts = [];
