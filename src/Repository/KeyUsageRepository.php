...
final class KeyUsageRepository implements RepoContract {
    ...
    private const PARAM_ALIASES = [ 'date' => 'usage_date' ];
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`key_usage`' : '"key_usage"';
     ...
     * [ 'key_id', 'usage_date' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $upd  = [ 'encrypt_count', 'decrypt_count', 'verify_count', 'last_used_at' ];
