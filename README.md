...
- Pkg folder: [packages\key-usage](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\key-usage)
...
graph LR
  ...
  key_usage["key_usage"]:::center
  key_usage -->|FK| crypto_keys["crypto_keys"]:::link
...
- Outbound (depends on): "crypto_keys"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-usage -Apply
